...
<body>
  ...
  <button id="left-scroll-button">Left</button>
  <button id="right-scroll-button">Right</button>

  <script src="script.js"></script>
  <script>
    var smoothHorizontalScroll = new smoothHorizontalScroll();
    smoothHorizontalScroll.init();
  </script>
</body>
</html>
